...
void print_benchmark(volatile unsigned int *periph_base)
{
    ...
    unsigned int bytes_transferred = (2048)*sizeof(stop_time);
    float time_spent_ns = (stop_time - start_time) * 8.0;
    float time_spent = time_spent_ns * 1e-9;
...
// first, get a pointer to the peripheral base address using /dev/mem and the function mmap
    ...
    printf("\r\n\r\n\r\nLab 6 Nicholas Gillum - Custom Peripheral Demonstration\n\r");
